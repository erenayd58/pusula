...
-- Denemeler (Faz 6a): 1 katalog denemesi (genel, 3 hafta önce) + Ayşe için 4 genel sonuç (8, 5, 3 hafta
-- önce; 3 hafta önceki katalog denemesi, 1 hafta önceki serbest) — netler yükselen, bir düşüş:
-- 52,00 → 58,33 → 55,67 → 63,33 (ceza 3; net generated). Konu işaretleri: Üslü İfadeler 4 denemenin
-- 3'ünde, Paragrafta Anlam 2'sinde (Parça 2 mock_weak). Mehmet aynı katalog denemesinde 1 sonuç
-- (karşılaştırma tablosu iki satır); Zeynep yok (boş durum). Grafik ≥ 4 genel deneme (Ayşe).
...
values (
  ...
  'c0000000-0000-4000-8000-000000000001', null, 'Demo Yayınları Türkiye Geneli 1', 'Demo Yayınları',
  (now() at time zone 'Europe/Istanbul')::date - 21, 'b0000000-0000-4000-8000-000000000002'
);

insert into public.mock_exam_results (id, student_id, mock_exam_id, custom_title, taken_on, duration_minutes, created_by)
values
  ('e1000000-0000-4000-8000-000000000001', 'b0000000-0000-4000-8000-000000000011', null, 'Kafa Dengi Deneme 1', (now() at time zone 'Europe/Istanbul')::date - 56, 150, 'b0000000-0000-4000-8000-000000000011'),
  ('e1000000-0000-4000-8000-000000000002', 'b0000000-0000-4000-8000-000000000011', null, 'Kafa Dengi Deneme 2', (now() at time zone 'Europe/Istanbul')::date - 35, 155, 'b0000000-0000-4000-8000-000000000011'),
  ('e1000000-0000-4000-8000-000000000003', 'b0000000-0000-4000-8000-000000000011', 'e0000000-0000-4000-8000-000000000001', null, (now() at time zone 'Europe/Istanbul')::date - 21, 155, 'b0000000-0000-4000-8000-000000000011'),
  ('e1000000-0000-4000-8000-000000000004', 'b0000000-0000-4000-8000-000000000011', null, 'Kafa Dengi Deneme 3', (now() at time zone 'Europe/Istanbul')::date - 7, 148, 'b0000000-0000-4000-8000-000000000011'),
  ('e1000000-0000-4000-8000-000000000011', 'b0000000-0000-4000-8000-000000000012', 'e0000000-0000-4000-8000-000000000001', null, (now() at time zone 'Europe/Istanbul')::date - 20, null, 'b0000000-0000-4000-8000-000000000002');

-- Ders satırları (ders sırası: TUR, MAT, FEN, INK, DIN, ING; soru sayıları 20/20/20/10/10/10).
insert into public.mock_exam_subject_results (result_id, subject_id, correct_count, wrong_count, blank_count, wrong_penalty)
select r.result_id::uuid, r.subject_id::uuid, r.correct, r.wrong, r.blank, 3
from (values
  -- Ayşe 1: 52,00
  ('e1000000-0000-4000-8000-000000000001', 'c1000000-0000-4000-8000-000000000001', 14, 3, 3),
  ('e1000000-0000-4000-8000-000000000001', 'c1000000-0000-4000-8000-000000000002', 10, 6, 4),
  ('e1000000-0000-4000-8000-000000000001', 'c1000000-0000-4000-8000-000000000003', 12, 3, 5),
  ('e1000000-0000-4000-8000-000000000001', 'c1000000-0000-4000-8000-000000000004',  7, 3, 0),
  ('e1000000-0000-4000-8000-000000000001', 'c1000000-0000-4000-8000-000000000005',  8, 0, 2),
  ('e1000000-0000-4000-8000-000000000001', 'c1000000-0000-4000-8000-000000000006',  7, 3, 0),
  -- Ayşe 2: 58,33
  ('e1000000-0000-4000-8000-000000000002', 'c1000000-0000-4000-8000-000000000001', 15, 2, 3),
  ('e1000000-0000-4000-8000-000000000002', 'c1000000-0000-4000-8000-000000000002', 12, 4, 4),
  ('e1000000-0000-4000-8000-000000000002', 'c1000000-0000-4000-8000-000000000003', 13, 3, 4),
  ('e1000000-0000-4000-8000-000000000002', 'c1000000-0000-4000-8000-000000000004',  8, 2, 0),
  ('e1000000-0000-4000-8000-000000000002', 'c1000000-0000-4000-8000-000000000005',  8, 0, 2),
  ('e1000000-0000-4000-8000-000000000002', 'c1000000-0000-4000-8000-000000000006',  6, 0, 4),
  -- Ayşe 3 (katalog): 55,67
  ('e1000000-0000-4000-8000-000000000003', 'c1000000-0000-4000-8000-000000000001', 14, 3, 3),
  ('e1000000-0000-4000-8000-000000000003', 'c1000000-0000-4000-8000-000000000002', 11, 4, 5),
  ('e1000000-0000-4000-8000-000000000003', 'c1000000-0000-4000-8000-000000000003', 13, 1, 6),
  ('e1000000-0000-4000-8000-000000000003', 'c1000000-0000-4000-8000-000000000004',  7, 2, 1),
  ('e1000000-0000-4000-8000-000000000003', 'c1000000-0000-4000-8000-000000000005',  8, 0, 2),
  ('e1000000-0000-4000-8000-000000000003', 'c1000000-0000-4000-8000-000000000006',  6, 0, 4),
  -- Ayşe 4 (serbest): 63,33
  ('e1000000-0000-4000-8000-000000000004', 'c1000000-0000-4000-8000-000000000001', 16, 2, 2),
  ('e1000000-0000-4000-8000-000000000004', 'c1000000-0000-4000-8000-000000000002', 13, 3, 4),
  ('e1000000-0000-4000-8000-000000000004', 'c1000000-0000-4000-8000-000000000003', 15, 2, 3),
  ('e1000000-0000-4000-8000-000000000004', 'c1000000-0000-4000-8000-000000000004',  8, 1, 1),
  ('e1000000-0000-4000-8000-000000000004', 'c1000000-0000-4000-8000-000000000005',  8, 0, 2),
  ('e1000000-0000-4000-8000-000000000004', 'c1000000-0000-4000-8000-000000000006',  6, 0, 4),
  -- Mehmet (katalog): 41,66
  ('e1000000-0000-4000-8000-000000000011', 'c1000000-0000-4000-8000-000000000001', 12, 2, 6),
  ('e1000000-0000-4000-8000-000000000011', 'c1000000-0000-4000-8000-000000000002',  8, 6, 6),
  ('e1000000-0000-4000-8000-000000000011', 'c1000000-0000-4000-8000-000000000003', 10, 5, 5),
  ('e1000000-0000-4000-8000-000000000011', 'c1000000-0000-4000-8000-000000000004',  6, 3, 1),
  ('e1000000-0000-4000-8000-000000000011', 'c1000000-0000-4000-8000-000000000005',  7, 0, 3),
  ('e1000000-0000-4000-8000-000000000011', 'c1000000-0000-4000-8000-000000000006',  5, 3, 2)
) as r (result_id, subject_id, correct, wrong, blank);

-- Konu işaretleri: Üslü İfadeler (Mat) 1., 2., 3. denemede; Paragrafta Anlam (Türkçe) 3. ve 4. denemede.
insert into public.mock_exam_topic_mistakes (result_id, topic_id) values
  ('e1000000-0000-4000-8000-000000000001', 'c2000000-0000-4000-8000-000000002002'),
  ('e1000000-0000-4000-8000-000000000002', 'c2000000-0000-4000-8000-000000002002'),
  ('e1000000-0000-4000-8000-000000000003', 'c2000000-0000-4000-8000-000000002002'),
