 ...
 * listesinde görünür; eşik değiştirilince (ayar formu, owner) sonuç değişir. Seed'deki "Sözcükte
 * Anlam" 20 gün önce oturmuş, son kaydı 12 gün önce → varsayılan tekrar günleriyle (7, 15, 30)
 * "Tekrar zamanı"; tekrar günü 90 yapılınca uyarı düşer. Kurum geneli ayar değiştiği için
 * `shared-desktop` projesi (seri, diğer projelerden önce); ayar `finally` içinde geri alınır.
 * Öğrenci Bugün kartı testi `alerts.spec.ts`'te (iki projede) kalır.
 */
...
test.describe("konu uyarıları (kurum ayarı)", () => {
